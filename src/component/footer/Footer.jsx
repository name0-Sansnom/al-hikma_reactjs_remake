...
import './footer.css'
import Footer_I from "../../asset/footer.png";
      ...
      <div class="footer">
        ...
        <div class="upper">
          <div class="logo-second">
            <img src={Footer_I} alt="footer" />
            <h4>
              Bring your wards for the best circular <br /> education with
          ...
          <div class="contact-second">
            <h1>Contact Us:</h1>
            <div class="icons">
              <AddressIcon footer-address={true} />
            </div>
            </div>
          ...
          <hr />
          <div class="doc">
            <p>Copyrights &copy;2023 Al-Hikmah Islamic Montessori School</p>
          </div>
